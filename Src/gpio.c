...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(BT_HEARTBEAT_GPIO_Port, BT_HEARTBEAT_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : MOTOR_L_A_Pin MOTOR_L_B_Pin MOTOR_R_A_Pin MOTOR_R_B_Pin */
  ...
  /*Configure GPIO pin : BT_HEARTBEAT_Pin */
  GPIO_InitStruct.Pin = BT_HEARTBEAT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
